...
function validaCadastro() {
  ...
  if (document.getElementById('inputNome').value == "") {
    ...
    inputCelular.focus();
    return false;
  } else if (document.getElementById('inputEmail').value == "" || document.getElementById('inputEmail').value.indexOf('@') == -1 || document.getElementById('inputEmail').value.indexOf('.') == -1) {
    document.getElementById("inputEmail").classList.add('is-invalid');
    inputEmail.focus();
    return false;
...
function validaEmail() {
  if (document.getElementById('inputEmail_reset').value == "" || document.getElementById('inputEmail_reset').value.indexOf('@') == -1 || document.getElementById('inputEmail_reset').value.indexOf('.') == -1) {
...
function onlynumber(evt) {
  ...
  key = String.fromCharCode(key); //var regex = /^[0-9.,]+$/;
